...
The SDK is distributed through a Maven repository, which allows developers to add it to their project easily by adding a dependency to their \texttt{build.gradle} file.
