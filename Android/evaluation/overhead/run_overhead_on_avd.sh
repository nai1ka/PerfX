...
RESULTS_DIR="$SCRIPT_DIR/results/$AVD"
...
"$SCRIPT_DIR/measure_overhead.sh" noSdk

# ── run withSdk flavor ────────────────────────────────────────────────────────
echo ""
echo "=== Running withSdk measurement ==="
"$SCRIPT_DIR/measure_overhead.sh" withSdk

# ── save results ──────────────────────────────────────────────────────────────
echo ""
echo "=== Saving results to $RESULTS_DIR ==="
mkdir -p "$RESULTS_DIR"
cp "$SCRIPT_DIR/results/noSdk.csv" \
   "$SCRIPT_DIR/results/withSdk.csv" \
   "$SCRIPT_DIR/results/noSdk_startup.txt" \
   "$SCRIPT_DIR/results/withSdk_startup.txt" \
   "$RESULTS_DIR/"
